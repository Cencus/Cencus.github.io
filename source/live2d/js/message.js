...
if(!norunFlag){
	...
	function initLive2d (){
		...
		//获取位置
		var landR = sessionStorage.getItem("historywidth");
		var landB = sessionStorage.getItem("historyheight");
		if(landR == null || landB ==null){
			landR = '5'
			landB = '0'
		}
		$('#landlord').css('right',landR+'px');
		...
		smcc.onmousedown = function(){
			...
			moveRight = parseInt(obj.style.right);
			...
			document.onmousemove = function(){
				if(moveable){
					var ent = getEvent();
					var x = moveRight - (ent.clientX - moveX);
			...
			document.onmouseup = function(){
				if(moveable){
					var historywidth = obj.style.right;
